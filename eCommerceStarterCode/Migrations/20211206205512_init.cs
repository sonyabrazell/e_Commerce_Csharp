    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "AspNetRoles",
                keyColumn: "Id",
                keyValue: "2d78ed21-a37a-465a-a857-694d2a8e39d3");

            migrationBuilder.DeleteData(
                table: "AspNetRoles",
                keyColumn: "Id",
                keyValue: "9bae02f1-b2ef-40e1-83e9-fb4a4ebd0287");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { "2d78ed21-a37a-465a-a857-694d2a8e39d3", "c5f572e3-efc7-4640-8b87-a779c0bf6785", "User", "USER" });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { "9bae02f1-b2ef-40e1-83e9-fb4a4ebd0287", "650da510-c7d6-49c5-b301-d1601aefddcb", "Admin", "ADMIN" });
        }
    }
}
